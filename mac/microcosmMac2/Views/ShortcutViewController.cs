...
namespace microcosmMac2.Views
{
    public partial class ShortcutViewController : AppKit.NSViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            ctrlYShortCut.RemoveAllItems();
            ctrlUShortCut.RemoveAllItems();
            ctrlIShortCut.RemoveAllItems();
            ctrlOShortCut.RemoveAllItems();
            ctrlPShortCut.RemoveAllItems();
            ...
            foreach (KeyValuePair<EShortCut, string> s in shortCutList)
            {
                ...
                ctrlYShortCut.AddItem(s.Value);
                ctrlUShortCut.AddItem(s.Value);
                ctrlIShortCut.AddItem(s.Value);
                ctrlOShortCut.AddItem(s.Value);
                ctrlPShortCut.AddItem(s.Value);
            ...
            ctrlYShortCut.SelectItem(shortCutList[appDelegate.shortCut.ctrlY]);
            ctrlUShortCut.SelectItem(shortCutList[appDelegate.shortCut.ctrlU]);
            ctrlIShortCut.SelectItem(shortCutList[appDelegate.shortCut.ctrlI]);
            ctrlOShortCut.SelectItem(shortCutList[appDelegate.shortCut.ctrlO]);
            ctrlPShortCut.SelectItem(shortCutList[appDelegate.shortCut.ctrlP]);
        ...
        partial void SubmitClick(Foundation.NSObject sender)
        {
            ...
            appDelegate.shortCut.ctrlY = Util.ShortCutStringToEnum(ctrlYShortCut.SelectedItem.Title);
            appDelegate.shortCut.ctrlU = Util.ShortCutStringToEnum(ctrlUShortCut.SelectedItem.Title);
            appDelegate.shortCut.ctrlI = Util.ShortCutStringToEnum(ctrlIShortCut.SelectedItem.Title);
            appDelegate.shortCut.ctrlO = Util.ShortCutStringToEnum(ctrlOShortCut.SelectedItem.Title);
            appDelegate.shortCut.ctrlP = Util.ShortCutStringToEnum(ctrlPShortCut.SelectedItem.Title);
            ...
            appDelegate.keyEventCtrl[16] = appDelegate.shortCut.ctrlY;
            appDelegate.keyEventCtrl[32] = appDelegate.shortCut.ctrlU;
            appDelegate.keyEventCtrl[34] = appDelegate.shortCut.ctrlI;
            appDelegate.keyEventCtrl[31] = appDelegate.shortCut.ctrlO;
